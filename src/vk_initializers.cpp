...
{
    VkCommandPoolCreateInfo info = {};   //{} - чтобы инициализировалось всё нулём
...
VkCommandBufferAllocateInfo vkinit::command_buffer_allocate_info(
    VkCommandPool pool, VkCommandBufferLevel level, uint32_t count /*=1*/)
{
...
VkSemaphoreSubmitInfo vkinit::semaphore_submit_info(VkPipelineStageFlags2 stageMask, VkSemaphore semaphore)
{
	...
	submitInfo.value = 1;   //semaphores могут быть счётчиками
